...
export const SignUpPage = () => {
  ...
  return (
    <div className=" md:flex ">
      <div className="md:w-1/2 md:mx-8">
        <div className=" block ">
          <div className="my-6 mx-4 text-left">
            ...
            <p className="text-[#475467] text-sm text-center my-2">
      ...
      <Card className="hidden md:w-1/2 h-screen md:flex items-center justify-center p-8 text-center text-white bg-blue-800 bg-opacity-90">
